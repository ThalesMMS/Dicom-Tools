...
BACKEND_LIBRARIES = {
    ...
    "test_gdcm": {
        "input": "none",
        "output": "display",
        "description": "Executa testes unitários GDCM (C++).",
        "option_keys": [],
        "has_options": False,
    },
    "test_dcmtk": {
        "input": "none",
        "output": "display",
        "description": "Executa testes unitários DCMTK (C++).",
        "option_keys": [],
        "has_options": False,
    },
    "test_itk": {
        "input": "none",
        "output": "display",
        "description": "Executa testes unitários ITK (C++).",
        "option_keys": [],
        "has_options": False,
    },
    "test_vtk_unit": {
        "input": "none",
        "output": "display",
        "description": "Executa testes unitários VTK (C++).",
        "option_keys": [],
        "has_options": False,
    },
    "test_utils": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de utilidades C++ (filesystem/helpers).",
        "option_keys": [],
        "has_options": False,
    },
    "test_integration": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de integração C++ (fluxos GDCM/DCMTK).",
        "option_keys": [],
        "has_options": False,
    },
    "test_edge_cases": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de edge cases/erro C++.",
        "option_keys": [],
        "has_options": False,
    },
    "test_validation": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de validação C++.",
        "option_keys": [],
        "has_options": False,
    },
    "run_cpp_tests": {
        "input": "none",
        "output": "display",
        "description": "Roda todos os testes C++ (target run_cpp_tests ou ctest).",
        "option_keys": [],
        "has_options": False,
    },
    "test_anonymize_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de anonimização fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "test_uid_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de UID fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "test_datetime_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de data/hora fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "test_charset_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de charset fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "test_dictionary_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de dicionário fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "test_file_operations_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de operações de arquivo fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "test_sequence_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de sequência fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "test_value_representation_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de VR fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "test_option_parser_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de parsing de opções fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "test_stats_helpers_cs": {
        "input": "none",
        "output": "display",
        "description": "Executa testes de helpers de estatística fo-dicom (C#).",
        "option_keys": [],
        "has_options": False,
    },
    "run_cs_tests": {
        "input": "none",
        "output": "display",
        "description": "Roda todos os testes C# (dotnet test).",
        "option_keys": [],
        "has_options": False,
    },
}
...
DEFAULTS = {
    ...
    "cpp": {
        ...
        "test_gdcm": {"input": DEFAULT_SERIES, "output": OUTPUT_DIR},
        "test_dcmtk": {"input": DEFAULT_SERIES, "output": OUTPUT_DIR},
        "test_itk": {"input": DEFAULT_SERIES, "output": OUTPUT_DIR},
        "test_vtk_unit": {"input": DEFAULT_SERIES, "output": OUTPUT_DIR},
        "test_utils": {"input": DEFAULT_SERIES, "output": OUTPUT_DIR},
        "test_integration": {"input": DEFAULT_SERIES, "output": OUTPUT_DIR},
        "test_edge_cases": {"input": DEFAULT_SERIES, "output": OUTPUT_DIR},
        "test_validation": {"input": DEFAULT_SERIES, "output": OUTPUT_DIR},
        "run_cpp_tests": {"input": DEFAULT_SERIES, "output": OUTPUT_DIR},
    },
    "java": {
        "info": {"input": DEFAULT_FILE, "options": {"json": True}},
        ...
        "test_uid": {"input": DEFAULT_FILE},
        "test_datetime": {"input": DEFAULT_FILE},
        "test_charset": {"input": DEFAULT_FILE},
        "test_workflow": {"input": DEFAULT_FILE},
        "test_validation_java": {"input": DEFAULT_FILE},
        "run_java_tests": {"input": DEFAULT_FILE},
    },
    "csharp": {
        "info": {"input": DEFAULT_FILE, "options": {"json": True}},
        ...
        "sr_summary": {"input": DEFAULT_FILE},
        "rt_check": {"input": DEFAULT_FILE, "options": {"dose": "", "struct": ""}},
        "test_anonymize_cs": {"input": DEFAULT_FILE},
        "test_uid_cs": {"input": DEFAULT_FILE},
        "test_datetime_cs": {"input": DEFAULT_FILE},
        "test_charset_cs": {"input": DEFAULT_FILE},
        "test_dictionary_cs": {"input": DEFAULT_FILE},
        "test_file_operations_cs": {"input": DEFAULT_FILE},
        "test_sequence_cs": {"input": DEFAULT_FILE},
        "test_value_representation_cs": {"input": DEFAULT_FILE},
        "test_option_parser_cs": {"input": DEFAULT_FILE},
        "test_stats_helpers_cs": {"input": DEFAULT_FILE},
        "run_cs_tests": {"input": DEFAULT_FILE},
    },
    "js": {
        "info": {"input": DEFAULT_FILE, "options": {"json": True}},
